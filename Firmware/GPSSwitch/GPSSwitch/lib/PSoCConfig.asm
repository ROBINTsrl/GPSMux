...
export LoadConfig_gpsswitch
export _LoadConfig_gpsswitch
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_gpsswitch
	lcall	LoadConfigTBL_gpsswitch_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration gpsswitch
;
;    Load configuration registers for gpsswitch.
...
;               CUR_PP
;
_LoadConfig_gpsswitch:
 LoadConfig_gpsswitch:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_gpsswitch_Bank0
    mov     X, <LoadConfigTBL_gpsswitch_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_gpsswitch_Bank1
    mov     X, <LoadConfigTBL_gpsswitch_Bank1
